...
This is a sample app demoing Cypress's experimental feature: Cypress Studio, which makes writing end-to-end tests so much easier by _showing Cypress exactly how to test_ by clicking through the DOM while Cypress records your actions. The full blog post showing how to use this is available on newline.co.
